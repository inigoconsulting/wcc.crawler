...
class NewsletterSpider(CrawlSpider, NewsletterItemExtractorMixin):
    ...
    name = 'piefnewsletter-en'
    allowed_domains = ['www.oikoumene.org']
    start_urls = [
            'http://www.oikoumene.org/en/programmes/public-witness-addressing-power-affirming-peace/churches-in-the-middle-east/pief/news-events/pief-newsletter.html'
    ]
    rules = (
        Rule(SgmlLinkExtractor(allow=(
            '^.*?/en/programmes/public-witness-addressing-power-affirming-peace/churches-in-the-middle-east/pief/news-events/newsletter/.*\.html',
